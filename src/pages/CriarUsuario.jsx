...
const CriarUsuario = ({ adicionarUsuario }) => {
  ...
  const criarUsuarioFunc = async (lead) => {
    ...
    try {
      const response = await fetch('https://script.google.com/macros/s/AKfycbwDRDM53Ofa4o5n7OdR_Qg3283039x0Sptvjg741Hk7v0DXf8oji4aBpGji-qWHMgcorw/exec?v=criar_usuario', {
        method: 'POST',
        mode: 'no-cors',
